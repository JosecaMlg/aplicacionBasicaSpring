...
import com.apijccp.service.spring.security.CustomAuthority;
...
public class JwtAuthenticatonFilter extends OncePerRequestFilter {
	...
	private boolean needsAuthenticate(Claims claims) {
	...
	private void setUpSpringAuthentication(Claims claims) {
		...
		CustomUserDetails cud = userDetailsService.loadUserByUsername(claims.get("username", String.class));
		List<CustomAuthority> authorities = seguridadService.getAuthoritiesByIDUser(cud.getIdUsuario());
